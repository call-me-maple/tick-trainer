...
public enum Pickaxe
{
    ...
    DRAGON_PICKAXE(2.83f, 61, ItemID.DRAGON_PICKAXE, ItemID.DRAGON_PICKAXE_12797,
            ...
            ItemID.INFERNAL_PICKAXE_UNCHARGED, ItemID._3RD_AGE_PICKAXE, ItemID.INFERNAL_PICKAXE_OR,
            ItemID.INFERNAL_PICKAXE_UNCHARGED_25369, ItemID.CRYSTAL_PICKAXE_INACTIVE),
    CRYSTAL_PICKAXE(2.75f, 71, ItemID.CRYSTAL_PICKAXE, ItemID.CRYSTAL_PICKAXE_23863),
    UNKNOWN,
    ;
